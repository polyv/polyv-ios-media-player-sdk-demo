...
@implementation PLVVodMediaSubtitleItem
...
- (NSString *)description {
    return [NSString stringWithFormat:@"%02f --> %02f : %@",
            PLVVodMediaSubtitleTimeGetSeconds(self.startTime),
            PLVVodMediaSubtitleTimeGetSeconds(self.endTime),
            self.text];
}
